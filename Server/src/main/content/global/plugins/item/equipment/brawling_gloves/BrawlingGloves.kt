package content.global.plugins.item.equipment.brawling_gloves

import core.game.node.entity.skill.Skills
import shared.consts.Items

/**
 * Represents the brawling gloves.
 */
enum class BrawlingGloves(@JvmField val id: Int, @JvmField val charges: Int, @JvmField val indicator: Int, val skillSlot: Int) {
    /**

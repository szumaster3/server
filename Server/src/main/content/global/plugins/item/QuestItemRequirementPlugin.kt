...
class QuestItemRequirementPlugin : InteractionListener {
    ...
    private val lostCityWeapons = intArrayOf(Items.DRAGON_DAGGER_1215, Items.DRAGON_DAGGERP_1231, Items.DRAGON_DAGGERP_PLUS_5680, Items.DRAGON_DAGGERP_PLUS_PLUS_5698, Items.DRAGON_LONGSWORD_1305)
    ...
    private val dragonSlayerEquipment = intArrayOf(Items.RUNE_PLATEBODY_1127, Items.RUNE_PLATEBODY_G_10798, Items.RUNE_PLATEBODY_G_2615, Items.RUNE_PLATEBODY_G_13800, Items.RUNE_PLATEBODY_T_10800, Items.RUNE_PLATEBODY_T_13805, Items.RUNE_PLATEBODY_T_2623, Items.ZAMORAK_PLATEBODY_2653, Items.SARADOMIN_PLATEBODY_2661, Items.GUTHIX_PLATEBODY_2669, Items.GREEN_DHIDE_BODY_1135, Items.DHIDE_BODYG_7370, Items.DHIDE_BODY_T_7372)
    private val questCapes = intArrayOf(Items.QUEST_POINT_CAPE_9813, Items.QUEST_POINT_HOOD_9814)
    private val godBooks = intArrayOf(Items.HOLY_BOOK_3840, Items.UNHOLY_BOOK_3842)
    private val pharaohScepters = intArrayOf(Items.PHARAOHS_SCEPTRE_9044, Items.PHARAOHS_SCEPTRE_9045, Items.PHARAOHS_SCEPTRE_9046, Items.PHARAOHS_SCEPTRE_9047, Items.PHARAOHS_SCEPTRE_9048, Items.PHARAOHS_SCEPTRE_9049, Items.PHARAOHS_SCEPTRE_9050, Items.PHARAOHS_SCEPTRE_9051)
        ...
        onEquip(questCapes) { player, _ ->
            ...
            if (player.questRepository.points < maxQP) {
                player.packetDispatch.sendMessage(
                    "You cannot equip the Quest cape without completing all available quests.",
                )
                return@onEquip false
            }
            return@onEquip true

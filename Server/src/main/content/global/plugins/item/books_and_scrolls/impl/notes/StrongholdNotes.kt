package content.global.plugins.item.books_and_scrolls.impl.notes
        ...
        private val CONTENTS =
            arrayOf(
                PageSet(
                    Page(
                        BookLine(
                            "Chapters<br><br>" + DARK_BLUE + "Description<br>" + DARK_BLUE + "Level 1<br>" + DARK_BLUE +
                                    "Level 2<br>" +
                                    DARK_BLUE +
                                    "Level 3<br>" +
                                    DARK_BLUE +
                                    ...
                                    "Navigation<br>" +
                                    DARK_BLUE +
                                    "Diary<br><br><br><br><br><br><br><br><br><br>",
                            38,
                        ),
                    ),
                    Page(
                        BookLine(
                            DARK_BLUE +
                                    "Description<br>This stronghold was<br>unearthed by a miner<br>prospecting for new ores<br>around the Barbarian Village.<br>After gathering some<br>equipment he ventured into<br>the maze of tunnels and was<br>missing for a long time. He<br>finally emerged along with<br>copious notes refarding the<br>new beasts and strange<br>experiences which had befallen<br>him. He also mentioned that<br>there was treasure to be had,",
                            53,
                        ),
                    ),
                ),

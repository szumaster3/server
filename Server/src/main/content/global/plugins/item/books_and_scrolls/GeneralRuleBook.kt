package content.global.plugins.item.books_and_scrolls
        ...
        private val CONTENTS =
            arrayOf(
                ...
                PageSet(
                    Page(
                        BookLine(
                            BLUE + "7 - Using Third Party <br>" + BLUE +
                                "Software<br><br>You must not use other<br>programs to gain an unfair<br>advantage in the game.",
                            38,
                        ),
                    ),
                    Page(
                        BookLine(
                            BLUE + "8 - Multi Logging-in</col><br><br>If you create more than one<br>" + SERVER_NAME +
                                " account, they<br>must not interact. This<br>includes giving items to a<br>friend to transfer to another<br>account you own.",
                            53,
                        ),
                    ),
                ),
                PageSet(
                    Page(
                        BookLine(
                            BLUE + "9 - Encouraging Others to<br>" + BLUE +
                                "Break Rules</col><br><br>You must not encourage<br>others to break any of the<br>" +
                                SERVER_NAME +
                                " rules.",
                            38,
                        ),
                        BookLine(
                            BLUE + "10 - False Representation</col><br><br>You must not misuse<br>" + SERVER_NAME +
                                " Customer<br>Support.Trying to get<br>another player into trouble<br>by reporting them for no<br>reason or framing them is an<br>abuse of the Customer<br>Support Team's service.<br> want to help as many<br>players as possible and so the<br>Customer Support Team's<br>service must be used<br>appropriately and treated with",
                            53,
                        ),
                    ),
                ),
                PageSet(
                    Page(
                        ...
                        BookLine(
                            BLUE +
                                "11 - Website Advertising</col><br><br>You are not allowed to<br>actively advertise any<br>websites, fan-sites, IRC<br>channels or product<br>anywhere in " +
                                SERVER_NAME +
                                ",<br>including the " +
                                SERVER_NAME +
                                "<br>forums.",
                ...
                PageSet(
                    Page(
                        BookLine(
                            BLUE + "12 - Real World Item<br>" + BLUE + "Trading<br><br></col>" + SERVER_NAME +
                                " items must only<br>be exchanged for other items<br>or service within the game.<br>Buying or selling items<br>outside of the " +
                                SERVER_NAME +
                                "<br>environment is not in the<br>spirit of the game and is easy<br>for " +
                                SERVER_NAME +
                                " to trace!",
                            38,
                        ),
                        BookLine(
                            BLUE + "13 - Asking for Personal<br>" + BLUE +
                                "Details<br><br></col>To protect player's safety<br>and privacy, you must not<br>ask for personal details. This<br>includes full names, phone<br>numbers, MSN, AIM, email<br>and home/school addresses!",
                            53,
                        ),
                    ),
                ),
                PageSet(
                    Page(
                        BookLine(
                            BLUE + "14 - Misuse of Official<br>" + BLUE +
                                "Forums</col><br><br>Forums must be used in<br>accordance with the Forum<br>Code of Conduct and treated<br>with respect at all times.",
                            38,
                        ),
                        BookLine(
                            BLUE +
                                "15 - Advert Blocking<br><br>Blocking the adverts in the<br>free to play version of<br>" +
                                SERVER_NAME +
                                " is against the<br>rules.",
                            53,
                        ),
                    ),
                ),

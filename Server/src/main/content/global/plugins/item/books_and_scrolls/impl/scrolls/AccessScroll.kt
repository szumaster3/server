package content.global.plugins.item.books_and_scrolls.impl.scrolls
...
class AccessScroll : InteractionListener {
    ...
    override fun defineListeners() {
        on(Items.SCROLL_7968, IntType.ITEM, "read") { player, _ ->
            ...
            sendString(
                player,
                "I, King Vargas, proclaim that the bearer of this<br>scroll is the Regent of Miscellania.",
                MESSAGE_SCROLL,
                3
            )
            return@on true

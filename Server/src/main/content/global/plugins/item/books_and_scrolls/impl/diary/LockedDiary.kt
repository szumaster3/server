package content.global.plugins.item.books_and_scrolls.impl.diary
...
class LockedDiary : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(Scenery.SANDY_S_DESK_10805, IntType.SCENERY, "search") { player, _ ->
            ...
            if (!inInventory(player, Items.LOCKED_DIARY_11761) && getAttribute(
                    player,
                    GameAttributes.RETURNING_CLARENCE_CHECKPOINT,
                    false
                )
            ) {

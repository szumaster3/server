 ...
 */
@Initializable
public final class AnimationRoomPlugin extends MapZone implements Plugin<java.lang.Object> {
    ...
    private void animateArmour(final Player player, final Scenery scenery, final ArmourSet set) {
        ...
        GameWorld.getPulser().submit(new Pulse(5, player) {
            ...
            public boolean pulse() {
                ...
                NPC npc = new AnimatedArmourPlugin(player, scenery.getLocation(), set);

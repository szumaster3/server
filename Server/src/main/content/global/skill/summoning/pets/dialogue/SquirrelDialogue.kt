...
class SquirrelDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            2 -> playerl(FaceAnim.FRIENDLY, "It's another kind of animal. Squirrels are more famous for eating nuts than chasing balls.").also { stage++ }
            ...
            5 -> playerl(FaceAnim.FRIENDLY, "Not just now, I wouldn't want to spoil your dinner with one.").also { stage++ }
            ...
            9 -> playerl(FaceAnim.FRIENDLY, "I'll be done in a moment, and you can play here if you want.").also { stage++ }
            ...
            13 -> playerl(FaceAnim.FRIENDLY, "Then whatever answer I gave still applies now.").also { stage = END_DIALOGUE }
        }
        return true
    }

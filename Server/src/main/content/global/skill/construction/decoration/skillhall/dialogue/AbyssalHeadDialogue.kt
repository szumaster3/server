...
class AbyssalHeadDialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            4 -> npc(FaceAnim.CHILD_FRIENDLY, "You must take all your gold and all your most valued", "items, and take them into$DARK_RED THE ABYSS</col> without", "weapons or armour.").also { stage++ }
            ...
            8 -> npc(FaceAnim.CHILD_NORMAL, "I bet you just rush through it though. Everyone there", "is in such a rush. No one stops to appreciate the", "beauty of$DARK_RED THE ABYSS</col>.").also { stage++ }
            ...
            11 -> npc(FaceAnim.CHILD_FRIENDLY, "Death is a small thing compared to the beauty of$DARK_RED THE", "$DARK_RED ABYSS</col>.").also { stage = END_DIALOGUE }
            12 -> npc(FaceAnim.CHILD_FRIENDLY, "Poor deluded fool. There is no hope for you at all.").also { stage = END_DIALOGUE }
            13 -> npc(FaceAnim.CHILD_FRIENDLY, "But does not the fear contribute to your appreciation", "of$DARK_RED THE ABYSS</col>?").also { stage = END_DIALOGUE }
            ...
            15 -> when (buttonID) {
                ...
                2 -> player(FaceAnim.HALF_GUILTY, "I suppose fear does heighten the senses.").also { stage = 17 }
            }
            16 -> npcl(FaceAnim.CHILD_EVIL_LAUGH, "Poor human. You must not judge$DARK_RED THE ABYSS</col> by the standards of this world. You must learn to embrace your fear as part of the experience of$DARK_RED THE ABYSS</col>.").also { stage = END_DIALOGUE }
            17 -> npcl(FaceAnim.CHILD_FRIENDLY, "Then you should enhance them further by raising the stakes. Next time you go to$DARK_RED THE ABYSS</col> you should take all your most valuable items with you.").also { stage = END_DIALOGUE }
        }
    }
}

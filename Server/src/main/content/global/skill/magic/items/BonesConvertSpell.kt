...
import content.minigame.mage_training.plugin.CreatureGraveyardPlugin
...
class BonesConvertSpell : SpellListener("modern") {
    ...
    private val boneConvertGraphics = Graphics(shared.consts.Graphics.BONES_TO_BANANAS_141, 92)

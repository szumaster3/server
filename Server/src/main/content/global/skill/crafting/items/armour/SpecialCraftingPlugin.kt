...
class SpecialCraftingPlugin : InteractionListener {
    ...
    override fun defineListeners() {
        craft(items = FeatherHeaddress.FEATHER, base = Items.COIF_1169, level = 79, amount = 20) { player, used ->
        ...
        craft(items = Snelms.SHELLS, base = Items.CHISEL_1755, level = 15) { player, used ->
        ...
        craft(items = intArrayOf(Items.FRESH_CRAB_CLAW_7536, Items.FRESH_CRAB_SHELL_7538), base = Items.CHISEL_1755, level = 15) { player, used ->
    ...
    /**
     * Generic method to register crafting by using an item on a base.
     */
    private fun craft(
        items: IntArray,
        base: Int,

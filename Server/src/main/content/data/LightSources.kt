...
enum class LightSources(val level: Int, val emptyId: Int, val fullId: Int = -1, val litId: Int, val sfxId: Int = -1, val open: Boolean = false, val interfaceId: Int = -1) {
    ...
    /**
     * Gets the strength of the light source.
     * 1 = dim, 2 = medium, 3 = bright.
     */
    fun getStrength(): Int = when (interfaceId) {
    ...
    /**
     * Checks if this light source is permanent (cannot be extinguished).
     */
    ...
    companion object {
        ...
        /**
         * Checks if the player has any active non-permanent light source.
        ...
        /**
         * Returns any active light source from inventory or equipment (including permanent ones).
         */
        @JvmStatic
        ...
        /**
         * Returns the first active non-permanent light source from inventory or equipment.
         */
        @JvmStatic

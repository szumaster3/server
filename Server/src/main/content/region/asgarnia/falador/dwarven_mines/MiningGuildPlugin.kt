package content.region.asgarnia.falador.dwarven_mines
...
class MiningGuildPlugin : InteractionListener {
    ...
    override fun defineListeners() {
        ClassScanner.definePlugins(
            MiningGuildDwarfDialogue(),
            DwarfSkillcapeDialogue()
        )
    ...
    /**
     * Represents the Mining Guild Dwarf (Mining guild) dialogue.
     */
    inner class MiningGuildDwarfDialogue(player: Player? = null) : Dialogue(player) {
     ...
     */
    inner class DwarfSkillcapeDialogue(player: Player? = null) : Dialogue(player) {

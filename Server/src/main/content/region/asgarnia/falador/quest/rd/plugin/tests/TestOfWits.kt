...
class TestOfWits(private val dialogueNum: Int = 0) : DialogueBuilderFile() {
    companion object {
            ...
            .let { branch ->
                ...
                branch
                    ...
                    .let { branch ->
                        branch
                            .onValue(0)
                            .npc(FaceAnim.THINKING, "Here is my riddle:", "I estimate there to be one million inhabitants in the world", "of @servername, creatures and people both.")
                            .npc(FaceAnim.THINKING, "What number would you get if you multiply", "the number of fingers on everything's left hand, to the", "nearest million?")
                            .manualStage { _, player, _, _ ->
                                sendInputDialogue(player, true, "Enter the amount:") { value: Any ->
                                    ...
                                    openDialogue(player, TestOfWits(), NPC(NPCs.MS_HYNN_TERPRETT_2289))
                                }
                            }
                            .end()

                        branch.onValue(1).npc(FaceAnim.THINKING, "Here is my riddle:", "Which of the following statements is true?").options().let { optionBuilder ->
                        ...
                        branch
                            .onValue(3)
                            .npc(FaceAnim.THINKING, "Here is my riddle:", "Imagine that you have been captured by an enemy.", "You are to be killed, but in a moment of mercy, the", "enemy has allowed you to pick your own demise.")
                            ...
                            .npc(FaceAnim.THINKING, "Your third choice is to be thrown to a pack of wolves", "that have not been fed in over a month.")
                            .npc(FaceAnim.THINKING, "Your final choice of fate is to be thrown from the walls", "of a castle, many hundreds of feet high.")
                        ...
                        branch
                            .onValue(4)
                            .npc(FaceAnim.THINKING, "Here is my riddle:", "I dropped four identical stones, into four identical", "buckets, each containing an identical amount of water.")
                            .npc(FaceAnim.THINKING, "The first bucket's water was at 32 degrees Fahrenheit,", "the second was at 33 degrees, the third at 34 and the", "fourth was at 35 degrees.")

...
class OldCroneAhoyDialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (questStage) {
            3 -> when (stage) {
                0 -> if(inInventory(player!!, Items.CUP_OF_TEA_4245)) {
                    player("Here's a lovely cup of tea for you, in your own special cup.").also { stage = 9 }
                } else {
                    player("Were you once a disciple of Necrovarus in the Temple", "of Phasmatys, old woman?").also { stage++ }
                }
                ...
                9 -> npc("Oh no, it hasn't got milk in it. I only drink", "tea with milk, I'm afraid.").also { stage++ }
                10 -> {
                    end()
            ...
            4 -> when (stage) {
                0 -> if(inInventory(player!!, Items.CUP_OF_TEA_4246)) {
                    player("Here's a lovely cup of milky tea for you, in your", "own special cup.").also { stage++ }
                } else if(inInventory(player!!, Items.MODEL_SHIP_4253)) {
                    player("I am afraid I have not found your son yet.").also { stage = 29 }
                } else {
                    player("Do you know where I can find nettles around here?").also { stage = 36 }
                }
                ...
                29 -> npc("I never expected that you would find him - although if you do, please let me know.").also { stage++ }
                30 -> options("Remind me - what can I do about Necrovarus?", "What did you want me to get for you?", "I'll go and search for those items you asked for.").also { stage++ }
                31 -> when (buttonID) {
                    1 -> player("Remind me - what can I do about Necrovarus?").also { stage++ }
                    2 -> player("What did you want me to get for you?").also { stage = 33 }
                    3 -> player("I'll go and search for those items you asked for.").also { stage = END_DIALOGUE }
                }

                32 -> npc("There is an enchantment that I can perform on such", "an amulet that will give it the power of command over", "ghosts. It will work only once, but it will enable you to", "command Necrovarus to let the ghosts pass on.").also { stage = END_DIALOGUE }
                33 -> npc("Necrovarus had a magical robe for which he must have", "no more use. Only these robes hold the power needed", "to perform the enchantment.").also { stage++ }
                34 -> npc("All his rituals come from a book written by an ancient", "sorcerer from the East called Haricanto. Bring me this", "strange book.").also { stage++ }
                35 -> npc("I cannot read the strange letters of the eastern lands.", "I will need something to help me translate the book.").also { stage = END_DIALOGUE }
            }
            6 -> when (stage) {

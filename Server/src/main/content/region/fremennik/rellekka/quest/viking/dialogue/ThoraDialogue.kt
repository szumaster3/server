...
class ThoraDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            1 -> npcl(FaceAnim.AMAZED, "How did you hear about that? I didn't think anybody knew about that.").also { stage++ }
            2 -> npcl(FaceAnim.HAPPY, "Well, it is true that in my younger years as a barkeep, I wandered the lands trying various alcoholic delicacies.").also { stage++ }
            3 -> npcl(FaceAnim.HAPPY, "Do know how many different types of alcohol there are here in Gielinor? Lots!").also { stage++ }
            4 -> npcl(FaceAnim.HAPPY, "Well, anyway, I used a fusion of various drinks from all around the world to create the greatest cocktail ever made!").also { stage++ }
            5 -> npcl(FaceAnim.HAPPY, "Of course, when my wander lust was gone, and I returned to Rellekka to serve as barkeep here, I gave all that up.").also { stage++ }
            ...
            8 -> playerl(FaceAnim.ASKING, "And you have all the ingredients here? I don't need to go chasing round the world for obscure ingredients to make it?").also { stage++ }
            ...
            17 -> npcl(FaceAnim.ANGRY, "If you can get him to sign a contract promising that he will NEVER EVER EVER darken my doorway here again, you get the drink.").also { stage++ }
            18 -> playerl(FaceAnim.ASKING, "Any idea how I can get him to do that?").also { stage++ }
            19 -> npcl(FaceAnim.HAPPY, "Knowing that little horror, he'll probably be willing to in exchange for some cash. You should go ask him yourself though.").also {
            ...
            26 -> npcl(FaceAnim.HAPPY, "Here you go, on the house! You have made my life SO much easier! Knowing that little monster won't be bugging me in here all the time anymore!").also { stage++ }
            27 -> npcl(FaceAnim.HAPPY, "That little weasel will have to abide by this written promise that Askeladden can never ever enter the Longhall again! He can't get round this one!").also { stage++ }
            28 -> playerl(FaceAnim.SUSPICIOUS, "Uh... yeah... yeah, you probably won't see someone called Askeladden coming in here...").also { stage = 1000 }
            ...
            51 -> npcl(FaceAnim.ANNOYED, "Yes. Yes I do. I should have never trusted him not to come in here, even with that written promise. Anyway, do you want a drink or not?").also { stage++ }

...
class ThorvaldDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            66 -> npcl(FaceAnim.NEUTRAL, "Well, let us say that I am not totally against this concept. As a warrior, I appreciate the value of brave and powerful warriors to our clan, and even though you may be an outerlander,").also { stage++ }
            67 -> npcl(FaceAnim.NEUTRAL, "I will not hold this against you if you can prove yourself to be fierce of heart in a combat situation to me.").also { stage++ }
            68 -> playerl(FaceAnim.NEUTRAL, "So how can I prove that? You want to fight me? Come on then, bring it on! Right here, right now, buddy!").also { stage++ }
            69 -> npcl(FaceAnim.LOUDLY_LAUGHING, "Hahahahaha! You certainly show some spirit for an outerlander!").also { stage++ }
            70 -> npcl(FaceAnim.NEUTRAL, "But spirit does not always make a good warrior. It takes both skill and spirit to be so. I have a test that I give all Fremenniks on their path to be a member of the clan.").also { stage++ }
            71 -> npcl(FaceAnim.NEUTRAL, "My test will challenge both your combat prowess and your bravery equally. Should you pass it you will earn my vote at the council, and more importantly my respect for you as a warrior.").also { stage++ }
            72 -> npcl(FaceAnim.HALF_ASKING, "So what say you, outerlander? Are you prepared for the battle?").also { stage++ }
            73 -> options("Yes", "No").also { stage++ }
            74 -> when (buttonId) {
                1 -> playerl(FaceAnim.EVIL_LAUGH, "Am I prepared? I'll show you what combat's all about, you big sissy barbarian type guy!").also {
            ...
            100 -> when (buttonId) {
                ...
                3 -> playerl(FaceAnim.HALF_ASKING, "I don't really like fighting that much... Isn't there something else I can do to earn your vote at the council of elders?").also { stage = 130 }
            }
            110 -> npcl(FaceAnim.NEUTRAL, "I will not offer my vote to anybody whose bravery in combat I do not trust completely. You must go down that ladder and fight your foe to the death.").also { stage = END_DIALOGUE }
            120 -> npcl(FaceAnim.NEUTRAL, "Ah, a wise question before entering combat. His name is Koschei the deathless. He is something of a mystery, even to us.").also { stage++ }
            121 -> npcl(FaceAnim.NEUTRAL, "On one of our regular raiding parties, our longship discovered a man in the frozen waters far north-east of here. We took him aboard our ship, thinking he must be dead.").also { stage++ }
            122 -> npcl(FaceAnim.NEUTRAL, "To our amazement he was perfectly healthy, even though he must have been in those deadly icey waters for many weeks.").also { stage++ }
            123 -> npcl(FaceAnim.NEUTRAL, "He has no memory of who he is, or how he came to be there, except for his own name: Koschei. We named him 'The Deathless' because he is seemingly unkillable!").also { stage++ }
            124 -> npcl(FaceAnim.NEUTRAL, "Any combat technique used against him, he learns instantly! He also apparently can heal himself from any wound at will!").also { stage++ }
            125 -> npcl(FaceAnim.NEUTRAL, "When he attacks, his weapon moves like a whirlwind! He can hide his combat level from his opponents at will as well!").also { stage++ }
            126 -> npcl(FaceAnim.NEUTRAL, "He is truly a horribly fierce opponent to face! I am only glad that he has chosen to stay here with us!").also { stage++ }
            127 -> npcl(FaceAnim.NEUTRAL, "The daylight makes him feel weak, so we have built him his own battleground beneath this building, where he can train his fiercesome skills without being disturbed.").also { stage++ }
            128 -> playerl(FaceAnim.LAUGH, "But he can't REALLY be unkillable...").also { stage++ }
            129 -> playerl(FaceAnim.SUSPICIOUS, "...can he?").also { stage++ }
            130 -> npcl(FaceAnim.NEUTRAL, "Some say he cannot die, for he has hidden his heart outside of his body to be kept forever safe in a duck egg.").also { stage++ }
            131 -> npcl(FaceAnim.NEUTRAL, "Others say he has been cursed by the gods to wander this land forever, never knowing any peace in his life, but only combat.").also { stage++ }
            132 -> npcl(FaceAnim.NEUTRAL, "Some claim that the sword he carries is the source of all his power, and if he should lose it, then exactly one minute later, he will turn back into his true form; A weakened, lame, old man.").also { stage++ }
            133 -> playerl(FaceAnim.HALF_ASKING, "And what do you believe?").also { stage++ }
            134 -> npcl(FaceAnim.NEUTRAL, "I believe you shouldn't look a gift horse in the mouth. He is a fearfully powerful warrior, but more importantly; He is on OUR side, not against us.").also { stage++ }
            135 -> npcl(FaceAnim.NEUTRAL, "He is content testing the battle skills of anyone taking their Fremennik trials of manhood, and I am content knowing that should an enemy ever invade").also { stage++ }
            136 -> npcl(FaceAnim.NEUTRAL, "our town, while our warriors are out on a raiding party, Koschei will be able to hold off ANY invader long enough for us to make our return.").also { stage = END_DIALOGUE }
            140 -> npcl(FaceAnim.FRIENDLY, "Yes of course outerlander! If you bring me five raw sardines then I will vote for you instead!").also { stage++ }
            141 -> playerl(FaceAnim.EXTREMELY_SHOCKED, "REALLY?!?!?").also { stage++ }
            142 -> npcl(FaceAnim.LOUDLY_LAUGHING, "HAHAHAHAHAHA! No, of course not! You are stupid, even by outerlander standards!").also { stage++ }
            143 -> npcl(FaceAnim.NEUTRAL, "If you want my vote, you must pass my trial. It is as simple as that.").also { stage = END_DIALOGUE }
            ...
            204 -> npcl(FaceAnim.ANNOYED, "It is a tradition amongst us that the bravest and strongest are honoured with a table of champions to drink and feast all that they can in our Long Hall.").also { stage++ }
            205 -> npcl(FaceAnim.ANNOYED, "Unfortunately, there are only a fixed number of places available at the table, and these places were all filled many moons ago by others.").also { stage++ }
            206 -> npcl(FaceAnim.ANNOYED, "Although my worthiness is undeniable, the only way I may take my place is if one of those already there die, or give up their place to me voluntarily.").also { stage++ }
            ...
            211 -> npcl(FaceAnim.HAPPY, "You will need to persuade one of the revellers in the Long Hall to give up their token, and their place, in deference to my own worthiness somehow.").also { stage = END_DIALOGUE }
            214 -> npcl(FaceAnim.ANNOYED, "I'm afraid not, outerlander.").also { stage = END_DIALOGUE }
            215 -> npcl(FaceAnim.ANGRY, "Oh you would, would you outerlander? I have already told you, I will not demean myself with such a baby sitting job until I can sit in the Longhall with pride.").also { stage++ }
            216 -> playerl(FaceAnim.HAPPY, "It's a good thing I have the Champions' Token right here then, isn't it?").also { stage++ }
            217 -> npcl(FaceAnim.HAPPY, "Ah... well this is a different matter. With that token I can claim my rightful place as a champion in the Long hall!").also { stage++ }
            218 -> npcl(FaceAnim.HAPPY, "Here outerlander, I can suffer the indignity of playing babysitter if it means that I can then revel with my warrior equals in the Long Hall afterwards!").also {
                removeItem(player, Items.CHAMPIONS_TOKEN_3706)
                addItemOrDrop(player, Items.WARRIORS_CONTRACT_3710, 1)
                stage++
            }
            219 -> npcl(FaceAnim.HAPPY, "Here outerlander, take this contract; I will fulfill it to my utmost.").also { stage = END_DIALOGUE }
            220 -> npcl(FaceAnim.HAPPY, "You misunderstand, outerlander. Normally I will only battle for a noble cause, but have never been recognised as a true champion here.").also { stage++ }
            221 -> npcl(FaceAnim.HAPPY, "With this Champion's token, I can stand alongside my warrior brethren in the Long Hall, and revel in the glories of past victories together!").also { stage = END_DIALOGUE }
        }
        return true
    }

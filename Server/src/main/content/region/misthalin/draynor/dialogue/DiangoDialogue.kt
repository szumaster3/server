...
import content.global.plugins.iface.DiangoReclaimableInterface
...
class DiangoDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            11 -> npc(FaceAnim.LAUGH, "The crate was marked 'Dragon Plates'.", "Apparently they thought it was some kind of armour,", "when really it's just a plate!").also { stage++ }
            12 -> {
                end()

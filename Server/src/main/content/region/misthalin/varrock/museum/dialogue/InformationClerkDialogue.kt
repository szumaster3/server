...
class InformationClerkDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        npc(FaceAnim.FRIENDLY, "Welcome to Varrock Museum. How can I help you today?")
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                2 -> {
                    player(FaceAnim.HALF_ASKING, "Could you tell me about the Dig Site exhibit please?")
                    stage = 150
                }

                3 -> {
                    player(FaceAnim.HALF_ASKING,"Could you tell me about the Timeline exhibit please?")
                    stage = 170
                }

                4 -> {
                    player(FaceAnim.HALF_ASKING,"Could you tell me about the Natural History exhibit, please?")
                    stage = 180
                }

                5 -> {
                    player(FaceAnim.HALF_ASKING,"What is Kudos?")
                    stage = 230
                }
            }
            ...
            151 -> {
                npc("As you've passed your Earth Science exams at the Dig", "Site, you can go through into the cleaning area and clean", "off some finds. This will help our Dig Site display floor to", "give a more accurate view of life back in the 3rd and 5th Ages.")
                stage++
            }
            ...
            174 -> {
                npc("Ahh, that's due to the numbering being done as we were", "constructing the cases and putting the displays in them,", "then shuffling them into the right places. We thought", "rather than renumbering them all - such a boring job,")
                stage++
            }
            ...
            180 -> {
                npc("Why, yes. The Natural History exhibit has displays of", "various creatures you can find around " + settings!!.name + ".")
                stage++
            }

            181 -> {
                npc("I see you have already demonstrated some of your", "knowledge of the natural world in the Natural History", "exhibit, so why not pop down and do some more quizzes", "with Orlando! You can earn Kudos at the same time.")
                stage++
            }
            ...
            184 -> {
                npc("The study of natural history is simply the study of the", "history of the species. The species doesn't necessarily", "need to be an extinct one.")
                stage = 153
            }
            ...
            232 -> {
                npc("Well, recently we found a rather interesting island to the", "north of Morytania. We believe that it may be of", "archaeological significance. I suspect we'll be looking for", "qualified archaeologists once we have constructed our")
                stage++
            }

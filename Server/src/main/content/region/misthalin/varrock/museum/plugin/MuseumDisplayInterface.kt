...
class MuseumDisplayInterface : InterfaceListener, InteractionListener {
    ...
    override fun defineListeners() {
        val displayCases = listOf(
            Scenery.DISPLAY_CASE_24645 to description1,  // Barbarian Village map
            Scenery.DISPLAY_CASE_24650 to description2,  // Barbarian weapons
            Scenery.DISPLAY_CASE_24663 to description3,  // Dagon'hai tome
            Scenery.DISPLAY_CASE_24647 to description4,  // Black Knight armour
            Scenery.DISPLAY_CASE_24651 to description5,  // Weapons and runes
            Scenery.DISPLAY_CASE_24641 to description6,  // Bridge diorama
            Scenery.DISPLAY_CASE_24655 to description7,  // Broken arrows
            Scenery.DISPLAY_CASE_24629 to description8,  // Stone circle
            Scenery.DISPLAY_CASE_24654 to description9,  // Excalibur
            Scenery.DISPLAY_CASE_24660 to description10, // Gnome glider
            Scenery.DISPLAY_CASE_24648 to description11, // Infinity equipment
            Scenery.DISPLAY_CASE_24659 to description12, // Guardian
            Scenery.DISPLAY_CASE_38173 to description13, // Stone tablet
            Scenery.DISPLAY_CASE_24646 to description14, // Edgeville map
            Scenery.DISPLAY_CASE_24640 to description15, // Morytania map
            Scenery.DISPLAY_CASE_24622 to description16, // Gielinor map
            Scenery.DISPLAY_CASE_24643 to description17, // Observatory model
            Scenery.DISPLAY_CASE_24656 to description18, // Phoenix crossbow
            Scenery.DISPLAY_CASE_24628 to description19, // Archaeological finds
            Scenery.DISPLAY_CASE_24634 to description20, // Robert the Strong
            Scenery.DISPLAY_CASE_24631 to description21, // Rune essence rock
            Scenery.DISPLAY_CASE_24637 to description23, // Priestly warrior helms
            Scenery.DISPLAY_CASE_24649 to description25, // Silverlight
            Scenery.DISPLAY_CASE_24657 to description26, // Skeleton
            Scenery.DISPLAY_CASE_24621 to description27, // Soil layers
            Scenery.DISPLAY_CASE_24624 to description28, // Staff of Armadyl
            Scenery.DISPLAY_CASE_24635 to description29, // Star chart
            Scenery.DISPLAY_CASE_24627 to description30, // Golem statuette
            Scenery.DISPLAY_CASE_24625 to description31, // God symbols
            Scenery.DISPLAY_CASE_24644 to description32, // Werewolf
            Scenery.DISPLAY_CASE_24658 to description33, // White Knight armour
            Scenery.DISPLAY_CASE_24632 to description34, // World map
            Scenery.DISPLAY_CASE_24652 to description35, // Zamorakian symbol
            Scenery.DISPLAY_CASE_24539 to description36, // Old symbol
            Scenery.DISPLAY_CASE_24540 to description37, // Ancient symbol
            Scenery.DISPLAY_CASE_24541 to description38, // Saradominist vase
            Scenery.DISPLAY_CASE_24542 to description39A,// Pottery A
            Scenery.DISPLAY_CASE_24543 to description39B,// Pottery B (95 kudos)
            Scenery.DISPLAY_CASE_24544 to description40, // Jewellery
            Scenery.DISPLAY_CASE_24545 to description41, // Arrowheads
            Scenery.DISPLAY_CASE_24546 to description42, // Ancient talisman
            Scenery.DISPLAY_CASE_24547 to description43, // Zaros tablet
            Scenery.DISPLAY_CASE_24548 to description44, // Ancient coin
            Scenery.DISPLAY_CASE_24549 to description45, // Old coin
            Scenery.PAINTING_24620 to description46,     // King Lathas painting
            Scenery.DISPLAY_CASE_24661 to description47  // Ardougne map
        )

        displayCases.forEachIndexed { index, (scenery, description) ->
            on(scenery, IntType.SCENERY, "study") { player, node ->
                val n = node as core.game.node.scenery.Scenery
                val modelId = n.definition.modelIds?.firstOrNull() ?: return@on true

                setAttribute(player, interfaceModel, modelId)
                ...
                sendString(player, (index + 1).toString(), Components.VM_TIMELINE_534, 85)
        ...
        onUseWith(IntType.SCENERY, displayItems, Scenery.DISPLAY_CASE_24550) { player, used, with ->
            val displays = mapOf(
                Location(3262, 3448, 0) to (Items.OLD_SYMBOL_11182 to Vars.VARBIT_SCENERY_MUSEUM_DISPLAY_37_3646),
                Location(3259, 3448, 0) to (Items.OLD_COIN_11179 to Vars.VARBIT_SCENERY_MUSEUM_DISPLAY_45_3648),
                Location(3259, 3450, 0) to (Items.ANCIENT_COIN_11180 to Vars.VARBIT_SCENERY_MUSEUM_DISPLAY_44_3647),
                Location(3262, 3450, 0) to (Items.ANCIENT_SYMBOL_11181 to Vars.VARBIT_SCENERY_MUSEUM_DISPLAY_36_3645)
            )
            ...
            when (with.location) {
                ...
                in displays.keys -> {
                    val (requiredItem, varbit) = displays[with.location]!!

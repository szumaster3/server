...
object MuseumData {
    ...
    val displayCases: Map<Int, Array<String>> = mapOf(
        Scenery.DISPLAY_CASE_24645 to text1,
        Scenery.DISPLAY_CASE_24650 to text2,
        Scenery.DISPLAY_CASE_24663 to text3,
        Scenery.DISPLAY_CASE_24647 to text4,
        Scenery.DISPLAY_CASE_24651 to text5,
        Scenery.DISPLAY_CASE_24641 to text6,
        Scenery.DISPLAY_CASE_24655 to text7,
        Scenery.DISPLAY_CASE_24629 to text8,
        Scenery.DISPLAY_CASE_24654 to text9,
        Scenery.DISPLAY_CASE_24660 to text10,
        Scenery.DISPLAY_CASE_24648 to text11,
        Scenery.DISPLAY_CASE_24659 to text12,
        Scenery.DISPLAY_CASE_38173 to text13,
        Scenery.DISPLAY_CASE_24646 to text14,
        Scenery.DISPLAY_CASE_24640 to text15,
        Scenery.DISPLAY_CASE_24622 to text16,
        Scenery.DISPLAY_CASE_24643 to text17,
        Scenery.DISPLAY_CASE_24656 to text18,
        Scenery.DISPLAY_CASE_24628 to text19,
        Scenery.DISPLAY_CASE_24634 to text20,
        Scenery.DISPLAY_CASE_24631 to text21,
        Scenery.DISPLAY_CASE_24637 to text23,
        Scenery.DISPLAY_CASE_24649 to text25,
        Scenery.DISPLAY_CASE_24657 to text26,
        Scenery.DISPLAY_CASE_24621 to text27,
        Scenery.DISPLAY_CASE_24624 to text28,
        Scenery.DISPLAY_CASE_24635 to text29,
        Scenery.DISPLAY_CASE_24627 to text30,
        Scenery.DISPLAY_CASE_24625 to text31,
        Scenery.DISPLAY_CASE_24644 to text32,
        Scenery.DISPLAY_CASE_24658 to text33,
        Scenery.DISPLAY_CASE_24632 to text34,
        Scenery.DISPLAY_CASE_24652 to text35,
        Scenery.DISPLAY_CASE_24539 to text36,
        Scenery.DISPLAY_CASE_24540 to text37,
        Scenery.DISPLAY_CASE_24541 to text38,
        Scenery.DISPLAY_CASE_24542 to text39A,
        Scenery.DISPLAY_CASE_24543 to text39B,
        Scenery.DISPLAY_CASE_24544 to text40,
        Scenery.DISPLAY_CASE_24545 to text41,
        Scenery.DISPLAY_CASE_24546 to text42,
        Scenery.DISPLAY_CASE_24547 to text43,
        Scenery.DISPLAY_CASE_24548 to text44,
        Scenery.DISPLAY_CASE_24549 to text45,
        Scenery.PAINTING_24620     to text46,
        Scenery.DISPLAY_CASE_24661 to text47,
    )

    /*
     * Items that are in display cases on the base floor.
     */
    val artifactItems = intArrayOf(Items.OLD_COIN_11179, Items.ANCIENT_COIN_11180, Items.ANCIENT_SYMBOL_11181, Items.OLD_SYMBOL_11182, Items.DISPLAY_CABINET_KEY_4617)

    val displayCasesBaseFloor = mapOf(

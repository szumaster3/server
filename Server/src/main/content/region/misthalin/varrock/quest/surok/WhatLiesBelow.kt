    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        when (stage) {
            ...
            40 -> {
                ...
                line(player, "I need to deliver Rat's letter to !!Surok Magis?? in Varrock.", line++, true)
                line(player, "I need to talk to Surok about the secret he has for me.", line++, true)
                line(player, "I need to infuse the !!metal wand?? with !!chaos runes??", line++)
                line(player, "at the !!Chaos Altar??.", line++)
                line(player, "I also need to find or buy an empty !!bowl??.", line++)
            }
            ...
            50 -> {
                ...
                line(player, "I need to take the glowing wand I have created back to Surok in", line++, true)
                line(player, "Varrock with an empty bowl.", line++, true)
            ...
            60 -> {
                ...
                line(player, "I need to infuse the metal wand with chaos runes at the Chaos Altar.", line++, true)
                line(player, "I also need to find or buy an empty bowl.", line++, true)
                line(player, "I need to take the glowing wand I have created back to Surok", line++, true)
            ...
            80, 90 -> {
                ...
                line(player, "I need to defeat !!King Roald?? in Varrock so that", line++)
                line(player, "!!Zaff?? can remove the mind-control spell.", line++)
                line(player, "I need to tell !!Rat?? what has happened;", line++)
                line(player, "he is waiting for me south of Varrock.", line++)
            }
            ...
            100 -> {
                ...
                line(player, "I need to speak to !!Zaff?? of !!Zaff's Staffs?? in Varrock.", line++, true)
                line(player, "I need to tell !!Surok?? in Varrock that he is under arrest.", line++, true)
                line(player, "I need to defeat !!King Roald?? in Varrock so that", line++, true)
                line(player, "!!Zaff?? can remove the mind-control spell.", line++, true)
                line(player, "I need to tell !!Rat?? what has happened;", line++)
                line(player, "he is waiting for me south of Varrock.", line++)
                line++

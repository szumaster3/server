...
class JulietDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            2001 -> interpreter.sendDialogues(
                phil,
                FaceAnim.HALF_GUILTY,
            ...
            2006 -> interpreter.sendDialogues(
                phil,
                FaceAnim.HALF_GUILTY,
            ...
            2009 -> interpreter.sendDialogues(
                phil,
                FaceAnim.HALF_GUILTY,
            ...
            2010 -> interpreter.sendDialogues(
                phil,
                FaceAnim.FURIOUS,
            ...
            2013 -> interpreter.sendDialogues(
                phil,
                FaceAnim.FURIOUS,
            ...
            1 -> when (buttonId) {
                ...
                2 -> player(FaceAnim.HALF_GUILTY, "No, I think I'd have remembered if I'd met him.").also {
                    stage = 20
                }
            ...
            21 -> player(FaceAnim.HALF_GUILTY, "Sorry, but I don't even know what he looks like.").also {
                stage = END_DIALOGUE
            }

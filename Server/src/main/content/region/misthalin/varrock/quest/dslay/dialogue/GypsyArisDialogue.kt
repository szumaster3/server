        ...
        when (quest!!.getStage(player)) {
            ...
            0 -> {
                if (args.size > 1) {
                    ...
                    npc("Wally managed to arrive at the stone circle just as", "Delrith was summoned by a cult of chaos druids...").also { stage = 200 }
                    return true
                }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            0 -> when (stage) {
                ...
                2 -> options("Ok, here you go.", "Who are you calling young one?!", "No, I don't believe in that stuff.", "With silver?").also { stage = 3 }
                3 -> when (buttonId) {

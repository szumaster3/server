...
class GertrudeDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            5 -> npc(FaceAnim.HALF_GUILTY, "My beloved feline friends Fluffs. She's been purring by", "my side for almost a decade. Please, could you go", "search for her while I look over the kids?").also { stage++ }
            ...
            100 -> npc(FaceAnim.HALF_GUILTY, "Really? Thank you so much! I really have no idea", "where she could be!").also { stage++ }
            101 -> npc(FaceAnim.HALF_GUILTY, "I think my sons, Shilop and Wilough, saw the cat last.", "They'll be out in the market place.").also { stage++ }
            ...
            214 -> npcl(FaceAnim.HALF_GUILTY, "Hmmm...strange, he should be at the market.").also { stage = END_DIALOGUE }
            230 -> npc(FaceAnim.HALF_GUILTY, "Hello again, did you manage to find Shilop? I can't keep", "an eye on him for the life of me.").also { stage++ }
            ...
            240 -> npc(FaceAnim.HALF_GUILTY, "Oh dear, oh dear! Maybe she's just hungry.", "She loves doogle sardines but I'm all out.").also { stage++ }
            241 -> player(FaceAnim.HALF_ASKING, "Doogle sardines?").also { stage++ }
            242 -> npc(FaceAnim.HALF_ASKING, "Yes, raw sardines seasoned with doogle leaves.", "Unfortunately I've used all my doogle leaves,", "but you may find some in the woods out back.").also { stage = 304 }
            ...
            322 -> npc(FaceAnim.HALF_GUILTY, "If you hadn't found her kitten it would have died out", "there!").also { stage++ }
            323 -> player(FaceAnim.HALF_GUILTY, "That's ok, I like to do my bit.").also { stage++ }
            324 -> npc(FaceAnim.HALF_GUILTY, "I don't know how to thank you. I have no real material", "possessions. I do have kittens! I can only really look", "after one.").also { stage++ }
            325 -> player(FaceAnim.HALF_GUILTY, "Well, if it needs a home.").also { stage++ }
            326 -> npc(FaceAnim.HALF_GUILTY, "I would sell it to my cousin in West Ardougne. I hear", "there's a rat epidemic there. But it's too far.").also { stage++ }
            ...
            328 -> npc(FaceAnim.HALF_GUILTY, "Oh by the way, the kitten can live in your backpack,", "but to make it grow you must take it out and feed and", "stroke it often.").also { stage++ }
            ...
            503 -> {
                ...
                if (player.familiarManager.hasFamiliar()) {
                    val pet = player.familiarManager.familiar as content.global.skill.summoning.pets.Pet
                    for (i in kittens) {
                        if (pet.itemId == i) {
                            has = true
                            break

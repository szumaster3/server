...
/**
 * Represents the dialogue plugin used for the edgeville monk.
 * @author Vexia
 */
@Initializable
public final class EdgevilleMonkDialogue extends Dialogue {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 1:
			switch (buttonId) {
			case 1:
				interpreter.sendDialogues(player, FaceAnim.HALF_GUILTY, "Can you heal me? I'm injured.");
				stage = 10;
				break;
			case 2:
				interpreter.sendDialogues(player, FaceAnim.HALF_GUILTY, "Isn't this place built a bit out of the way?");
				stage = 20;
				break;
			case 3:
				interpreter.sendDialogues(player, FaceAnim.HALF_GUILTY, "How do i get farther into the monastery?");
				stage = 30;
				break;
		...
		case 11:
			...
			break;
		case 20:
			interpreter.sendDialogues(npc, FaceAnim.HALF_GUILTY, "We like it that way actually! We get disturbed less. We still", "get rather a large amount of travellers looking for", "sanctuary and healing here as it is!");
			stage = 21;
			break;
		case 21:
			end();
			break;
		case 30:
			interpreter.sendDialogues(npc, FaceAnim.HALF_GUILTY, "You'll need to talk to Abbot Langley about that. He's", "usually to be found walking the halls of the monastery.");
			stage = 21;
			break;
		}
		return true;

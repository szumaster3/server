...
class ExaminerDialogueFile : DialogueBuilderFile() {
    ...
    override fun create(b: DialogueBuilder) {
        b.onQuestStages(Quests.THE_DIG_SITE, 100).npcl(
                FaceAnim.HAPPY,
            ...
            .options().let { optionBuilder ->
                optionBuilder.option("Thanks.").player(FaceAnim.HAPPY, "Thanks!").end()
        ...
        b.onQuestStages(Quests.THE_DIG_SITE, 6, 7, 8, 9, 10, 11, 12).branch { player ->
                ...
                branch.onValue(0).npcl(FaceAnim.ANNOYED, "Well, what are you doing here? Get digging!").end()
                branch.onValue(1).playerl(FaceAnim.HALF_GUILTY, "I have lost my trowel.").npcl(
                        FaceAnim.THINKING,
        ...
        b.onQuestStages(Quests.THE_DIG_SITE, 5).playerl(FaceAnim.FRIENDLY, "Hello.")
            .npcl(FaceAnim.FRIENDLY, "Ah, hello again.").options().let { optionBuilder ->
                val continuePath = b.placeholder()
                optionBuilder.option_playerl("I am ready for the last exam...").goto(continuePath)
                optionBuilder.option_playerl("I am stuck on a question.").npcl(
                ...
                optionBuilder.option_playerl("Sorry, I didn't mean to disturb you.").npcl("Oh, no problem at all.")
                    .end()
                optionBuilder.option_playerl("I have lost my trowel.").branch { player ->
                        if (inInventory(player, Items.TROWEL_676)) {
                            0
                        } else {
                            1
                        ...
                        branch.onValue(0).npcl("Really? Look in your backpack and make sure first.").end()
                        branch.onValue(1).npcl(
                                "Deary me. That was a good one as well. It's a good job I have another. Here you go...",
                            ).endWith { _, player ->
                                addItemOrDrop(player, Items.TROWEL_676)
                            }
            ...
            .options().let { optionBuilder ->
                ...
                optionBuilder.optionIf("Samples may be mixed together safely.") { player ->
                    ...
                    }.playerl("Samples may be mixed together safely.").goto(continuePath)
                optionBuilder.optionIf("Samples cleaned, and carried only in specimen jars.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrPurpleExam3ObtainAnswer, false)
                    }.playerl("Samples cleaned, and carried only in specimen jars.").goto(continuePath)
                ...
                optionBuilder.optionIf("Brush quickly using a wet brush.") { player ->
                    ...
                    }.playerl("Brush quickly using a wet brush.").goto(continuePath)
                optionBuilder.optionIf("Brush carefully and slowly using short strokes.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrGreenExam3ObtainAnswer, false)
                    }.playerl("Brush carefully and slowly using short strokes.").goto(continuePath)
                ...
                optionBuilder.optionIf("Bones must not be taken from the site.") { player ->
                    ...
                    }.playerl("Bones must not be taken from the site.").goto(continuePath)
                ...
                optionBuilder.optionIf("Handle bones very carefully and keep them away from other samples.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrBrownExam3ObtainAnswer, false)
                    }.playerl("Handle bones very carefully and keep them away from other samples.").goto(continuePath)
                return@let continuePath.builder()
            }.npcl("Okay, that concludes the level 3 Earth Sciences exam.")
            .npcl(FaceAnim.HAPPY, "Let me add up the results...").branch { player ->
                var ansCount = 0
                if (getAttribute(player, TheDigSite.attributeFirstQuestion, -1) == 0 && getAttribute(
                        player,
                ...
                if (getAttribute(player, TheDigSite.attributeSecondQuestion, -1) == 0 && getAttribute(
                        player,
                        TheDigSite.attrGreenExam3ObtainAnswer,
                        false
                    )
                ) {
                    ansCount++
                }
                if (getAttribute(player, TheDigSite.attributeThirdQuestion, -1) == 2 && getAttribute(
                        player,
                        TheDigSite.attrBrownExam3ObtainAnswer,
                        false
                    )
                ) {
                    ansCount++
                ...
                branch.onValue(0).npcl(
                    ...
                    ).playerl(FaceAnim.SAD, "Ah... Yes... Erm.... I think I had better go and revise first!").end()

                branch.onValue(1).npcl(FaceAnim.FRIENDLY, "You got one question correct. Try harder!")
                    .playerl(FaceAnim.FRIENDLY, "Oh bother!").end()

                branch.onValue(2)
                    .npcl(FaceAnim.FRIENDLY, "You got two questions correct. A little more study and you will pass it.")
                    .playerl(FaceAnim.FRIENDLY, "I'm nearly there...").end()

                branch.onValue(3).npcl(FaceAnim.FRIENDLY, "You got all the questions correct, well done!")
                    .playerl(FaceAnim.FRIENDLY, "Hooray!").betweenStage { _, player, _, _ ->
                    ...
                    ).playerl(FaceAnim.FRIENDLY, "I can dig wherever I want now!").npcl(
                        FaceAnim.FRIENDLY,
        ...
        b.onQuestStages(Quests.THE_DIG_SITE, 4).playerl(FaceAnim.FRIENDLY, "Hello.")
            .npcl(FaceAnim.FRIENDLY, "Hello again.").options().let { optionBuilder ->
                val continuePath = b.placeholder()
                optionBuilder.option_playerl("I am ready for the next exam.").goto(continuePath)
                optionBuilder.option_playerl("I am stuck on a question.").npcl(
                        "Well, well, have you not been doing any studies? I am not giving you the answers, talk to the other students and remember the answers.",
                    ).end()
                optionBuilder.option_playerl("Sorry, I didn't mean to disturb you.").npcl("Oh, no problem at all.")
            ...
            .options().let { optionBuilder ->
                ...
                optionBuilder.optionIf("Samples cut and cleaned before transportation.") { player ->
                    ...
                    }.playerl("Samples cut and cleaned before transportation.").goto(continuePath)
                ...
                optionBuilder.optionIf("Samples taken in rough form; kept only in sealed containers.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrBrownExam2ObtainAnswer, false)
                    }.playerl("Samples taken in rough form; kept only in sealed containers.").goto(continuePath)
                return@let continuePath.builder()
            }.npcl("Okay, next question...").npcl(
                FaceAnim.NEUTRAL,
                ...
                optionBuilder.optionIf("Finds must not be handled by anyone.") { player ->
                    ...
                    }.playerl("Finds must not be handled by anyone.").goto(continuePath)
                optionBuilder.optionIf("Finds must be carefully handled.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrPurpleExam2ObtainAnswer, false)
                    }.playerl("Finds must be carefully handled.").goto(continuePath)
                ...
                optionBuilder.optionIf("Strike rock repeatedly until powdered.") { player ->
                    ...
                    }.playerl("Strike rock repeatedly until powdered.").goto(continuePath)
                ...
                optionBuilder.optionIf("Always handle with care; strike cleanly on its cleaving point.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrGreenExam2ObtainAnswer, false)
                    }.playerl("Always handle with care; strike cleanly on its cleaving point.").goto(continuePath)
            ...
            .npcl(FaceAnim.HAPPY, "Let me add up your total...").branch { player ->
                var ansCount = 0
                if (getAttribute(player, TheDigSite.attributeFirstQuestion, -1) == 2 && getAttribute(
                        player,
                        TheDigSite.attrBrownExam2ObtainAnswer,
                        false
                    )
                ) {
                    ansCount++
                ...
                if (getAttribute(player, TheDigSite.attributeSecondQuestion, -1) == 0 && getAttribute(
                        player,
                        TheDigSite.attrPurpleExam2ObtainAnswer,
                        false
                    )
                ) {
                    ansCount++
                }
                if (getAttribute(player, TheDigSite.attributeThirdQuestion, -1) == 1 && getAttribute(
                        player,
                        TheDigSite.attrGreenExam2ObtainAnswer,
                        false
                    )
                ) {
                    ansCount++
                ...
                branch.onValue(0).npcl(FaceAnim.ANGRY, "No, no, no! This will not do. They are all wrong. Start again!")
                    .playerl(FaceAnim.SAD, "Oh no!").npcl("More studying for you my @g[boy,girl].").end()

                branch.onValue(1).npcl(FaceAnim.FRIENDLY, "You got one question correct. At least it's a start.")
                    .playerl(FaceAnim.FRIENDLY, "Oh well..")
                    .npcl(FaceAnim.FRIENDLY, "Get out and explore the site, talk to people and learn!").end()

                branch.onValue(2)
                    .npcl(FaceAnim.FRIENDLY, "You got two questions correct. Not too bad, but you can do better...")
                    .playerl(FaceAnim.FRIENDLY, "Nearly got it.").end()

                branch.onValue(3).npcl(FaceAnim.FRIENDLY, "You got all the questions correct, well done!")
                    .playerl(FaceAnim.FRIENDLY, "Great, I'm getting good at this.").betweenStage { _, player, _, _ ->
        ...
        b.onQuestStages(Quests.THE_DIG_SITE, 1, 2, 3).branch { player ->
                ...
                val continuePath = b.placeholder()
                branch.onValue(1).playerl(FaceAnim.FRIENDLY, "Hello.").npcl(FaceAnim.FRIENDLY, "Hello again.")
                    .npcl(FaceAnim.FRIENDLY, "I am still waiting for your letter of recommendation.").options()
                    .let { optionBuilder ->
                        optionBuilder.option_playerl("I have lost the letter you gave me.").branch { player ->
                                ...
                                branch.onValue(0).npcl("Oh now come on. You have it with you!").end()
                                branch.onValue(1).npcl("You already have the letter in your bank.").end()
                                branch.onValue(2).npcl("That was foolish. Take this one and don't lose it!")
                                    .endWith { _, player ->
                ...
                branch.onValue(2).playerl(FaceAnim.FRIENDLY, "Hello.").npcl(FaceAnim.FRIENDLY, "Hello again.")
                    ...
                    }.npcl(FaceAnim.NEUTRAL, "Good, good. We will begin the exam...").goto(continuePath)
                branch.onValue(3).playerl(FaceAnim.FRIENDLY, "Hello.")
                    .npcl(FaceAnim.FRIENDLY, "Hello again. Are you ready for another shot at the exam?").options()
                    .let { optionBuilder ->
                        val continuePath2 = b.placeholder()
                        optionBuilder.option_playerl("Yes, I certainly am. ").goto(continuePath)
                        optionBuilder.option_playerl("No, not at the moment.")
                            .npcl(FaceAnim.NEUTRAL, "Okay, take your time if you wish.").end()
            ...
            .options().let { optionBuilder ->
                ...
                optionBuilder.optionIf("The study of gardening, planing and fruiting vegetation.") { player ->
                    ...
                    }.playerl("The study of gardening, planing and fruiting vegetation.").goto(continuePath)
                optionBuilder.optionIf("The study of the earth, its contents and history.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrGreenExam1ObtainAnswer, false)
                    }.playerl("The study of the earth, its contents and history.").goto(continuePath)
                ...
                optionBuilder.optionIf("Magic users, miners and their escorts.") { player ->
                    ...
                    }.playerl("Magic users, miners and their escorts.").goto(continuePath)
                ...
                optionBuilder.optionIf("All that have passed the appropriate Earth Sciences exam.") { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrBrownExam1ObtainAnswer, false)
                    }.playerl("All that have passed the appropriate Earth Sciences exam.").goto(continuePath)
                return@let continuePath.builder()
            }.npcl("Okay, next question...").npcl(
                FaceAnim.NEUTRAL,
                ...
                optionBuilder.optionIf("Heat-resistant clothing to be worn at all times.") { player ->
                    ...
                    }.playerl("Heat-resistant clothing to be worn at all times.").goto(continuePath)
                optionBuilder.option_playerl("Rubber chickens to be worn on the head at all times.").goto(continuePath)
                optionBuilder.optionIf(
                        "Gloves and boots to be warn at all times; proper tools must be used.",
                    ) { player ->
                        return@optionIf getAttribute(player, TheDigSite.attrPurpleExam1ObtainAnswer, false)
                    }.playerl("Gloves and boots to be warn at all times; proper tools must be used.").goto(continuePath)
                optionBuilder.option_playerl("Protective clothing to be worn; tools kept away from site.")
                    .goto(continuePath)
                return@let continuePath.builder()
            }.npcl("Okay, that covers the level 1 Earth Sciences exam.")
            .npcl(FaceAnim.HAPPY, "Let's see how you did...").branch { player ->
                var ansCount = 0
                if (getAttribute(player, TheDigSite.attributeFirstQuestion, -1) == 0 && getAttribute(
                        player,
                ...
                if (getAttribute(player, TheDigSite.attributeSecondQuestion, -1) == 2 && getAttribute(
                        player,
                ...
                branch.onValue(0).npcl(
                    ...
                    ).playerl(FaceAnim.SAD, "Oh dear...").npcl(
                ...
                branch.onValue(1).npcl(FaceAnim.FRIENDLY, "You got one question correct. Better luck next time.")
                    .playerl(FaceAnim.FRIENDLY, "Oh bother!")
                    .npcl(FaceAnim.FRIENDLY, "Do some more research. I'm sure other students could help you out.").end()

                branch.onValue(2).npcl(
                        FaceAnim.FRIENDLY,
                        "You got two questions correct. Not bad, just a little more revision needed.",
                    ).playerl(FaceAnim.FRIENDLY, "Oh well...").end()

                branch.onValue(3).npcl(FaceAnim.FRIENDLY, "You got all the questions correct. Well done!")
                    .playerl(FaceAnim.FRIENDLY, "Hey! Excellent!").betweenStage { _, player, _, _ ->
                        addItemOrDrop(player, Items.TROWEL_676)
        ...
        b.onPredicate { _ -> true }.playerl(FaceAnim.FRIENDLY, "Hello.").npcl(
                ...
                optionBuilder.option_playerl("Can I take an exam?").npcl(
                    ...
                    .playerl(FaceAnim.FRIENDLY, "But why are you writing the letter? Shouldn't he?").npcl(
                        FaceAnim.FRIENDLY,
                ...
                optionBuilder.option_playerl("Interesting...")
                    .npcl(FaceAnim.FRIENDLY, "You could gain much with an understanding of the world below.").end()
            }
    }
}

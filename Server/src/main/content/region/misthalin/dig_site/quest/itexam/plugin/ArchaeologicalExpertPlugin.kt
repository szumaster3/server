...
class ArchaeologicalExpertPlugin : InteractionListener {

    companion object {
        val ITEMS = intArrayOf(
            Items.ANCIENT_STAFF_4675,
            Items.UNIDENTIFIED_LIQUID_702,
            Items.NITROGLYCERIN_703,
            Items.CHEMICAL_POWDER_700,
            Items.AMMONIUM_NITRATE_701,
            Items.NUGGETS_680,
            Items.NEEDLE_1733,
            Items.ROTTEN_APPLE_1984,
            Items.BROKEN_GLASS_1469,
            Items.BROKEN_ARROW_687,
            Items.PANNING_TRAY_677,
            Items.BONES_526,
            Items.BUTTONS_688,
            Items.CRACKED_SAMPLE_674,
            Items.OLD_TOOTH_695,
            Items.RUSTY_SWORD_686,
            Items.BROKEN_STAFF_689,
            Items.BROKEN_ARMOUR_698,
            Items.DAMAGED_ARMOUR_697,
            Items.CERAMIC_REMAINS_694,
            Items.BELT_BUCKLE_684,
            Items.ANIMAL_SKULL_671,
            Items.SPECIAL_CUP_672,
            Items.TEDDY_673,
            Items.STONE_TABLET_699
        )
    }
...
//    val it: Int,
//) : DialogueFile() {
//    var i = ArchaeologicalExpertPlugin()
//    var n = NPC(i.archy)
//    var itemUsed = it
//
//    override fun handle(
...
//                    npcl(FaceAnim.FRIENDLY, "Good - that's three; I can exchange them for normal gold now. You can get this refined and make a profit!").also {
//                        stage = 131
//                    }
//                } else if (player!!.inventory.getAmount(i.nuggets) < 3) {
//                    npcl(FaceAnim.FRIENDLY, "I can't do much with these nuggets yet. Come back when you have 3 and I will exchange them for you.").also {
//                        stage = 99
//                    }
//                }
//            }
...
//    }
//
//    private fun replaceAll(originalItem: Int, newItem: Int) {

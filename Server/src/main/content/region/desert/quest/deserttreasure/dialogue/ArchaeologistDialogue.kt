...
private class ArchaeologistDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b.onQuestStages(Quests.DESERT_TREASURE, 0).player(FaceAnim.FRIENDLY, "Hello there.").branch { player ->
            ...
            branch.onValue(0).line("He seems to be lost in his own thoughts...").end()
            return@let branch
        }.onValue(1).npc(FaceAnim.FRIENDLY, "Howdy stranger. What brings you out to these parts?").let { path ->
            val originalPath = b.placeholder()
            path.goto(originalPath)
            originalPath.builder().options().let { optionBuilder ->
                optionBuilder.option("What are you doing here?").player(
                ...
                ).npcl("Was there something you specifically wanted?").goto(originalPath)
                optionBuilder.option("Do you have any quests?").player(
                    FaceAnim.FRIENDLY,
                    ...
                    optionBuilder2.option("Yes, I'll help you.").betweenStage { _, player, _, _ ->
                    ...
                    optionBuilder2.option("No thanks, I don't want to help.")
                        .playerl("No thanks. Playing delivery boy doesn't really sound like much fun to me. ").npcl(
                            " Well, okay. Can't say as I blame you for thinking that. I'll go take it there myself later I guess.",
                        ).end()
                }
                optionBuilder.option("Who are you?").playerl(FaceAnim.THINKING, "Who are you, anyway?").npc(
                ...
                ).playerl(FaceAnim.THINKING, "No, I really haven't.").npc(
                    FaceAnim.EXTREMELY_SHOCKED,
                ...
                optionBuilder.option("Nothing really.")
                    .playerl("Nothing really. I'm just wandering around for no good reason.").npcl(
                        "Uh-huh. Well, if you'll excuse me, I have a lot more work to do before I can bed down for the night.",
                    ).end()
            }
        }

        b.onQuestStages(Quests.DESERT_TREASURE, 1, 2)
            .npcl("So what did Terry Balando say about those etchings? Did he give you a translation for me?")
            .playerl("Um...yeah...about that... I kind of didn't go and speak to him yet...").npcl(
                "Well what are you waiting for? A written invitation? All I want you to do is take those etchings up to the digsite for me!",
            ).playerl("Okay, I'll do that then.").end()

        b.onQuestStages(Quests.DESERT_TREASURE, 3).playerl("Hello there.")
            .npcl("So what did Terry Balando say about those etchings? Did he give you a translation for me?")
            .playerl("Yeah, he did. I have it here in this book.").npcl(
                ...
                optionBuilder.option("Read book").endWith { _, player ->
            ...
            }.option("Don't read book").playerl("Yeah, I did. Kind of boring really.")
        ...
        b.onQuestStages(Quests.DESERT_TREASURE, 4).playerl("Hello there.")
            ...
            .playerl("Uh... don't you mean archaeologist?").npcl("Yeeees... An archaeologist...")
            .npcl("It's all this hot sun getting to me I think.").npcl(
            ...
            ).npcl("all over to the Museum of Varrock.").npcl(
            ...
            ).npcl("argument thirty percent split...").playerl("Fifty percent.").npcl("That's right!").npcl(
                "A purely for the sake of argument fifty-fifty split on this hypothetical treasure, should it exist...",
            ).npcl("Do you see where I'm going with this?").playerl(
            ...
            .npcl("So what do you say? Partners?").options().let { optionBuilder ->
                optionBuilder.option("Help him").playerl(
                    ...
                    .npcl("Good @g[lad,lass]! Well, if we split up we'll be able to find treasure quicker.").npcl(
                    ...
                    ).npcl("You head due South, see what you can find out about this tablet.").endWith { _, player ->
                ...
                optionBuilder.option("Don't help him")
                    ...
                    .npcl(
                    ...
                    ).npcl("ourselves!").npcl("C'mon... what do you say? Partners?").options().let { optionBuilder ->
                        optionBuilder.option("Help him").playerl(
                            "Well... I guess nobody is really going to lose out on anything, and we don't even know if there is any treasure...",
                        ).playerl("Aw, go on then. Count me in.")
                        ...
                        optionBuilder.option("Don't help him").playerl(
        ...
        b.onQuestStages(Quests.DESERT_TREASURE, 5).playerl("Hello there.")
            .npcl("Hello again. You find any signs of that treasure yet?").playerl("Not yet...").npcl(
        ...
        b.onQuestStages(Quests.DESERT_TREASURE, 6, 7, 8).playerl("Hello there.")
            ...
            .npcl("Diamonds of Azzanadra? That sounds very promising indeed!").playerl("So you have heard of them?")

...
class SmokeDiamondPlugin : InteractionListener {
    companion object {
...
private class StandingTorchTimer(
    ...
    override fun run(entity: Entity): Boolean {
        if (entity is Player) {
            when (timerIdentifier) {
                SmokeDiamondPlugin.timerIdentifierTorchNE ->
                    sendMessage(
                        entity,
                        "The North-east torch burns out...",
                    )

                SmokeDiamondPlugin.timerIdentifierTorchSE ->
                    sendMessage(
                        entity,
                        "The South-east torch burns out...",
                    )

                SmokeDiamondPlugin.timerIdentifierTorchSW ->
                    sendMessage(
                        entity,
                        "The South-west torch burns out...",
                    )

                SmokeDiamondPlugin.timerIdentifierTorchNW ->
                    sendMessage(
                        entity,

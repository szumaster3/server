...
class DronDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            4 -> when ((1..2).random()) {
                1 -> npcl(FaceAnim.ANGRY, "Wrong, wrong, wrong!").also { stage = END_DIALOGUE }
                2 -> npcl(FaceAnim.ANGRY, "You know nothing!").also { stage = END_DIALOGUE }
            }
            ...
            9 -> npcl(FaceAnim.ANNOYED, "Don't talk of my brother. He's not on my good side at the moment.").also { stage = END_DIALOGUE }
            ...
            52 -> npcl(FaceAnim.FRIENDLY, "Very well, you seem to know me quite well, I'll answer your questions best I can.").also { stage++ }
            53 -> playerl(FaceAnim.FRIENDLY, "Phew!").also { stage++ }
            54 -> npcl(FaceAnim.FRIENDLY, "Well what are they then?").also { stage++ }
            55 -> playerl(FaceAnim.FRIENDLY, "I'm trying to find out the history of the outpost near Ardougne. I was hoping you could help me.").also { stage++ }
            56 -> npcl(FaceAnim.FRIENDLY, "Let me see. Ah yes, I remember reading of a battle that took place at the outpost many years ago. Two ex-friends led forces in a small battle that ended with them pitted against each other at the top of").also { stage++ }
            57 -> npcl(FaceAnim.FRIENDLY, "the outpost as the sole survivors because of their superior strength.").also { stage++ }
            58 -> playerl(FaceAnim.FRIENDLY, "Ex-friends?").also { stage++ }
            59 -> npcl(FaceAnim.FRIENDLY, "They were once friends but a difference in their beliefs meant they fell out. One chose to follow the god Zamorak, whilst the other chose Saradomin.").also { stage++ }
            60 -> npcl(FaceAnim.FRIENDLY, "But finding themselves in this extreme situation at the top of the outpost caused them to see the errors of their ways, like the waste of life, the lost friendship and the wasted time.").also { stage++ }
            ...
            66 -> playerl(FaceAnim.FRIENDLY, "Well, I was wondering how you get the blood stains out of your clothes?").also { stage++ }
            67 -> npcl(FaceAnim.FRIENDLY, "BE GONE!").also { stage++ }
            68 -> {
                end()
                setVarbit(player, MHUtils.DRON_PROGRESS, 4, true)
                setAttribute(player, MHUtils.ATTRIBUTE_DRON_PROGRESS, true)
            }
            69 -> npcl(FaceAnim.FRIENDLY, "Look, I don't have time for weaklings, if you want conversation, talk to my brother Blanin!").also { stage = END_DIALOGUE }
        }
        return true
    }

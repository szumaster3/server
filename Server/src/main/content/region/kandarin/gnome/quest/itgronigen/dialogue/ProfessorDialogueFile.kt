    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> player("Aquarius!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 1)
                stage = 16
            }

            2 -> player("Capricorn!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 2)
                stage = 16
            }

            3 -> player("Sagittarius!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 3)
                stage = 16
            }

            4 -> player("Scorpio!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 4)
                stage = 16
            }
            ...
            6 -> player("Libra!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 6)
                stage = 16
            }

            7 -> player("Virgo!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 7)
                stage = 16
            }

            8 -> player("Leo!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 8)
                stage = 16
            }
            ...
            10 -> player("Cancer!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 10)
                stage = 16
            }

            11 -> player("Gemini!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 11)
                stage = 16
            }

            12 -> player("Taurus!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 12)
                stage = 16
            }
            ...
            14 -> player("Aries!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 14)
                stage = 16
            }

            15 -> player("Pisces!").also {
                setAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, 15)
                stage = 16
            }
            ...
            18 -> {
                when (getAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE, -1)) {
            ...
            100 -> {
                ...
                removeAttribute(player!!, ObservatoryPlugin.CONSTELLATION_ATTRIBUTE)

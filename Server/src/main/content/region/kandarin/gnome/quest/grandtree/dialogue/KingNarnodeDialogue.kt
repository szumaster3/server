...
class KingNarnodeDialogue : DialogueFile() {
    ...
    fun leadDownLadder() {
        /*
         * Handles NPC to walk to the trapdoor and climb the ladder.
         */
            ...
            0 -> {
                when (stage) {
                    ...
                    7 -> npcl(FaceAnim.OLD_DEFAULT, "Not here, follow me.").also {
                        stage = END_DIALOGUE
                        /*
                         * Handles npc walk to the trapdoor and climb the ladder.
                         */
                        leadDownLadder()
                    }
            ...
            100 -> {
                ...
                31 -> {
                    if (player!!.inventory.freeSlots() >= 2) {
                        ...
                        npcl(
                            FaceAnim.OLD_DEFAULT,
                            "You don't have inventory space for my book or the bark! Clear some space and speak to me again"
                        )

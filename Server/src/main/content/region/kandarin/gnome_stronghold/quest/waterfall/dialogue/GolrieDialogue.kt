package content.region.kandarin.gnome_stronghold.quest.waterfall.dialogue
...
class GolrieDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> npc(FaceAnim.OLD_NORMAL, "Oh that, yes have it, it's just some old elven junk I", "believe.").also {

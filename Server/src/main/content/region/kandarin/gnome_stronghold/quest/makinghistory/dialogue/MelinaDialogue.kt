...
class MelinaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> playerl(FaceAnim.FRIENDLY, "Erm. I think you're talking about Droalak. I believe he did love you and he's very sorry for leaving you!").also { stage++ }
            ...
            5 -> playerl(FaceAnim.FRIENDLY, "I've been talking to Droalak. I believe he left you but never returned.").also { stage++ }
            6 -> npcl(FaceAnim.FRIENDLY, "He did. I suppose he has asked you to tell me he's sorry. What an empty gesture!").also { stage++ }
            7 -> playerl(FaceAnim.FRIENDLY, "Well actually he told me to give you this amulet.").also { stage++ }
            8 -> npcl(FaceAnim.FRIENDLY, "A sapphire amulet! He remembers! It's just like the one he gave me before he left.").also { stage++ }

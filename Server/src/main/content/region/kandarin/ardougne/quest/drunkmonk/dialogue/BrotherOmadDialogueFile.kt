        ...
        when (questStage) {
            0 -> {
                when (stage) {
                    ...
                    1 -> npcl(FaceAnim.SAD, "*yawn*...oh, hello...*yawn* I'm sorry! I'm just so tired! I haven't slept in a week!").also { stage++ }
                    ...
                    3 -> when (buttonID) {
                        ...
                        2 -> playerl(FaceAnim.FRIENDLY, "Sorry! I'm too busy to hear your problems!").also { stage = END_DIALOGUE }
                    }
                    4 -> npcl(FaceAnim.SAD, "It's brother Androe's son! With his constant: Waaaaaah! Waaaaaaaaah! Androe said it's natural, but it's so annoying!").also { stage++ }
                    5 -> playerl(FaceAnim.NEUTRAL, "I suppose that's what kids do.").also { stage++ }
                    6 -> npcl(FaceAnim.SAD, "He was fine, up until last week! Thieves broke in! They stole his favourite sleeping blanket!").also { stage++ }
                    7 -> npcl(FaceAnim.SAD, "Now he won't rest until it's returned... ...and that, means neither can I!").also { stage++ }
                    ...
                    9 -> when (buttonID) {
                        ...
                        2 -> playerl(FaceAnim.FRIENDLY, "I'm sorry to hear that! I hope you find his blanket.").also { stage = END_DIALOGUE }
                    }
                    10 -> npcl(FaceAnim.HALF_WORRIED, "Please do. We won't be able to help you as we are peaceful men but we would be grateful for your help!").also { stage++ }
                    11 -> playerl(FaceAnim.HALF_ASKING, "Where are they?").also { stage++ }
                    12 -> npcl(FaceAnim.SAD, "They hide in a secret cave in the forest. It's hidden under a ring of stones. Please, bring back the blanket!").also {
            ...
            10 -> {
                when (stage) {
                    ...
                    22 -> if (player!!.inventory.containItems(Items.CHILDS_BLANKET_90)) {
                        playerl(FaceAnim.HAPPY, "Yes! I've recovered it from the clutches of the evil thieves!").also { stage = 30 }
                    } else {
                    ...
                    31 -> npcl(FaceAnim.HAPPY, "Really, that's excellent, well done! Maybe now I will be able to get some rest.").also { stage++ }
            ...
            20 -> {
                when (stage) {
                    ...
                    30 -> npcl(FaceAnim.HAPPY, "Much better now I'm sleeping well! Now I can organise the party.").also { stage++ }
                    31 -> playerl(FaceAnim.HAPPY, "Ooh! What party?").also { stage++ }
                    32 -> npcl(FaceAnim.HAPPY, "The son of Brother Androe's birthday party. He's going to be one year old!").also { stage++ }
                    33 -> playerl(FaceAnim.HAPPY, "That's sweet!").also { stage++ }
                    34 -> npcl(FaceAnim.HAPPY, "It's also a great excuse for a drink!").also { stage++ }
                    35 -> npcl(FaceAnim.NEUTRAL, "We just need Brother Cedric to return with the wine.").also { stage++ }
                    ...
                    38 -> npcl(FaceAnim.FRIENDLY, "Cedric is a member of the order too. We sent him out three days ago to collect wine. But he didn't return!").also { stage++ }
                    ...
                    997 -> npcl(FaceAnim.NEUTRAL, "Of course, but we need the wine first.").also { stage = END_DIALOGUE }
            ...
            50 -> {
                when (stage) {
                    ...
                    81 -> npcl(FaceAnim.HAPPY, "I have little to repay you with, but I'd like to offer you some rune stones. But first, let's party!").also { stage++ }

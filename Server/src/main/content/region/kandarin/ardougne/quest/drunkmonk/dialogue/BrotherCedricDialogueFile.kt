        ...
        when {
            ...
            questStage == 41 -> {
                when (stage) {
                    ...
                    5 -> npcl(FaceAnim.HAPPY, "In that case I'd better drink more wine! It helps me think.").also { stage = END_DIALOGUE }
            ...
            questStage == 42 -> {
                when (stage) {
                    ...
                    3 -> npcl(FaceAnim.HAPPY, "Well done! Now I'll fix this cart. You head back to Brother Omad and tell him I'll be there soon.").also { stage++ }
            ...
            questStage == 50 -> {
                when (stage) {
                    ...
                    1 -> npcl(FaceAnim.NEUTRAL, "Hi, I'm almost done here. Could you tell Omad that I'll be back soon?").also { stage = END_DIALOGUE }
                }
            }

            questStage == 100 -> {
                when (stage) {
                    0 -> npcl(FaceAnim.NEUTRAL, "Brother Omad sends you his thanks! He won't be in a fit state to thank you in person.").also { stage = END_DIALOGUE }
                }
            }
        }
    }

...
class GuidorDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> if (getQuestStage(player!!, Quests.BIOHAZARD) >= 16) {
                player("Hello again Guidor.").also { stage = 100 }
            } else {
                player("Hello, you must be Guidor. I understand that you are", "unwell.").also { stage++ }
            }
            1 -> npc(FaceAnim.ANNOYED, "Is my wife asking priests to visit me now? I'm a man", "of science for god's sake. ").also { stage++ }
            ...
            23 -> npc(FaceAnim.THINKING, "I'm very sorry, I can see that you've worked very", "hard for this... ... but it seems that someone has been", "lying to you.").also { stage++ }

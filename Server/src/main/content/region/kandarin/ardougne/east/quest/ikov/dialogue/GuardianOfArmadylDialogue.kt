...
class GuardianOfArmadylDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b.onPredicate { _ -> true }.branch { player ->
                ...
                branch.onValue(1).npcl("Thou is a foul agent of Lucien! Such an agent must die!").endWith { _, player ->
                        npc!!.attack(player)
                    }
                return@let branch
            }.onValue(0).npcl(
                ...
                optionBuilder.option("I seek the Staff of Armadyl.")
                    .playerl(FaceAnim.FRIENDLY, "I seek the Staff of Armadyl.").npcl(
                        FaceAnim.FRIENDLY,
                        ...
                        optionBuilder2.option_playerl("Lucien will give me a grand reward for it!").npcl(
                                FaceAnim.FRIENDLY,
                ...
                optionBuilder.option_playerl("Out of my way fool!")
                    .npcl(FaceAnim.FRIENDLY, "I may be a fool but I will not step aside!").options()
                    .let { optionBuilder2 ->
                        optionBuilder2.option_playerl("Why not?!").npcl(
                                FaceAnim.FRIENDLY,
                                "Only members of our order are allowed to handle the staff.",
                            ).end()
                        optionBuilder2.option_playerl("Then you must die!").endWith { _, player ->
                                npc!!.attack(player)
                            }
                        optionBuilder2.option_playerl("You're right, I will go now.").npcl(
                                FaceAnim.FRIENDLY,
                                "That is a wise decision. Stay a while and let your soul be cleansed!",
                            ).end()
                    }

                optionBuilder.option_playerl("What are your kind and what are you doing here?").npcl(
                        FaceAnim.FRIENDLY,
                        ...
                        optionBuilder2.option_playerl("What is the Armadyl?").npcl(
                                FaceAnim.FRIENDLY,
                                "Armadyl is the god we serve. We have been charged with guarding his sacred artifacts until he requires them.",
                            ).options().let { optionBuilder3 ->
                                optionBuilder3.option_playerl("Ah ok, thanks.").npcl(FaceAnim.FRIENDLY, "Go in peace.")
                                    .end()
                                optionBuilder3.option("Someone told me there were only three gods.").playerl(
                                        FaceAnim.FRIENDLY,
                        ...
                        optionBuilder2.option_playerl("Who are the Mahjarrat?").npcl(
                                FaceAnim.FRIENDLY,
                                ...
                                optionBuilder3.option("Did you say Lucien?").playerl(
                                        FaceAnim.FRIENDLY,
                                ...
                                optionBuilder3.option_playerl("I hope you're doing a good job then!")
                                    .npcl(FaceAnim.FRIENDLY, "Do not fear! We are devoted to our charge!").end()
                            }

                        optionBuilder2.option_playerl("Wow! You must be really old!").npcl(
                                FaceAnim.ANGRY,
                ...
                optionBuilder.option("How dare you call me a fool!")
                    ...
                    .npcl(FaceAnim.ANGRY, "We must cleanse the temple!").endWith { _, player ->
                        npc!!.attack(player)
                    }
                optionBuilder.option_playerl("I just thought of something I must do!")
                    .npcl(FaceAnim.ANGRY, "An agent of evil cannot be allowed to leave!").endWith { _, player ->
                        npc!!.attack(player)
                    }
                optionBuilder.option_playerl("You're right, it's time for my yearly bath.")
                    .line("The guardian splashes holy water over you.")
                    .npcl(FaceAnim.FRIENDLY, "You have been cleansed!").npcl(
                        FaceAnim.FRIENDLY,
                        ...
                        optionBuilder2.option_playerl("Ok! I'll help!").npcl(FaceAnim.FRIENDLY, "So he is close by?")
                            .playerl(FaceAnim.FRIENDLY, "Yes!").npcl(
                                FaceAnim.FRIENDLY,
                        ...
                        optionBuilder2.option_playerl("No! I shall not turn against my employer!")
                            .npcl(FaceAnim.ANGRY, "Fool! You will die for your sins!").endWith { _, player ->
                                npc!!.attack(player)
                            }
                        optionBuilder2.option_playerl("I need time to think.")
                            .npcl(FaceAnim.FRIENDLY, "Linger a while and be at peace.").end()
                    }
            }
    }
}

...
class ClerkDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        npc = args[0] as NPC
        npcl(FaceAnim.NEUTRAL, "Hello, welcome to the Civic Office of West Ardougne. How can I help you?")
        return true
    }
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, Quests.PLAGUE_CITY)) {
            ...
            12 -> when (stage) {
                ...
                2 -> npcl(FaceAnim.FRIENDLY, "Rather you than me! The mourners usually deal with that stuff, you should speak to them. Their headquarters are right near the city gate.").also { stage++ }
                ...
                4 -> when (buttonID) {
                    ...
                    2 -> playerl(FaceAnim.HALF_GUILTY, "Surely you don't let them run everything for you?").also { stage = 5 }
                }
                5 -> npcl(FaceAnim.FRIENDLY, "Well, they do know what they're doing here. If they did start doing something badly Bravek, the city warder, would have the power to override them. I can't see that happening though.").also { stage++ }
                ...
                7 -> when (buttonID) {
                    ...
                    3 -> playerl(FaceAnim.HALF_GUILTY, "This is urgent though! Someone's been kidnapped!").also { stage = 11 }
                }
                ...
                10 -> when (buttonID) {
                    1 -> playerl(FaceAnim.ANNOYED, "This is urgent though! Someone's been kidnapped!").also { stage = 11 }
                ...
                12 -> npcl(FaceAnim.HALF_GUILTY, "Mr Bravek, there's a man here who really needs to speak to you.").also { stage++ }
                13 -> {
                    end()

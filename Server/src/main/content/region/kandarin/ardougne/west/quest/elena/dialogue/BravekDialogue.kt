    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, Quests.PLAGUE_CITY)) {
            13 -> when (stage) {
                ...
                20 -> npcl(FaceAnim.FRIENDLY, "Hmmm let me think... Ouch! Thinking isn't clever. Ah here, she did scribble it down for me.").also { stage++ }
                21 -> {
            ...
            14 -> when (stage) {
                0 -> npcl(FaceAnim.NEUTRAL, "Uurgh! My head still hurts too much to think straight. Oh for one of Trudi's hangover cures!").also { stage++ }
                1 -> {
                    if (removeItem(player!!, Items.HANGOVER_CURE_1504)) {
                        ...
                        npcl(FaceAnim.NEUTRAL, "Ooh that's much better! Thanks, that's the clearest my head has felt in a month. Ah now, what was it you wanted me to do for you?").also { stage++ }
                        stage = 5
                    } else {
                        end()
                    }
                ...
                4 -> npcl(FaceAnim.NEUTRAL, "Ooh that's much better! Thanks, that's the clearest my head has felt in a month. Ah now, what was it you wanted me to do for you?").also { stage++ }
                5 -> playerl(FaceAnim.FRIENDLY, "I need to rescue a kidnap victim named Elena. She's being held in a plague house, I need permission to enter.").also { stage++ }

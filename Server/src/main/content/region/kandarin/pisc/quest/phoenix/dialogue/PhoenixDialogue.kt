...
class PhoenixDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (stage) {
            ...
            33 -> {
                npc(FaceAnim.OLD_NORMAL, "(Farewell, " + player.username + ".)")
                stage++
            }
            ...
            42 -> showTopics(
                ...
                IfTopic<Any?>("", 72, true, inInventory(player, Items.PHOENIX_EGGLING_14626, 1)),
                IfTopic<Any?>("Who was Si'morgh?", 48, true, getAttribute(player, GameAttributes.PHOENIX_LAIR_VISITED, false)),
            ...
            66 -> {
                npcl(FaceAnim.OLD_HAPPY, "(You know the rest of my story, " + player.username + ", because you have helped to continue writing it.)")
                stage++
            }
            ...
            68 -> {
                npcl(FaceAnim.OLD_HAPPY, "(It is no bother. In truth, it is nice to have someone to talk to - someone to call a friend. Thank you for listening, " + player.username + ".)")
                stage++
            }
            ...
            97 -> {
                npcl(FaceAnim.OLD_HAPPY, "(Thank you, " + player.username + ".)")
                stage++
            }

package content.region.kandarin.east_ardougne.npc
...
class SummonedZombieNPC @JvmOverloads constructor(id: Int = NPCs.SUMMONED_ZOMBIE_77, location: Location? = null) : AbstractNPC(id, location, true) {
     ...
     */
    override fun construct(id: Int, location: Location, vararg objects: Any): content.region.kandarin.east_ardougne.npc.SummonedZombieNPC {
        val npc = content.region.kandarin.east_ardougne.npc.SummonedZombieNPC(id, location)
    ...
    override fun finalizeDeath(killer: Entity?) {
        ...
        (owner?.behavior as? content.region.kandarin.east_ardougne.npc.NecromancerNPC)?.let { behavior ->

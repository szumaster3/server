        ...
        when (getQuestStage(player!!, Quests.MURDER_MYSTERY)) {
            ...
            1 -> when (stage) {
                ...
                2 -> showTopics(
                    ...
                    IfTopic("Did you hear any suspicious noises at all?", 6, getAttribute(player!!, MurderMystery.attributeNoiseClue, false)),
                    IfTopic("Do you know why so much poison was bought recently?", 11, getAttribute(player!!, MurderMystery.attributePoisonClue, 0) > 0)
                )
                ...
                4 -> npcl("She really hates me and was arguing with Lord Sinclair about trashing the garden a few days ago.").also { stage = 2 }
                5 -> npcl("Right here, by my little shed. It's very cosy to sit and think in.").also { stage = 2 }
                ...
                12 -> npcl("from that poison salesman the other day. I assume it was to sort out those bees. You'd really have to ask him though.").also { stage = 2 }
            }

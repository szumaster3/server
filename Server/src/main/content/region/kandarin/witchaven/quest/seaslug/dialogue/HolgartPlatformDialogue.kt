 ...
 */
@Initializable
class HolgartPlatformDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> {
                ...
                FishingPlatformBoat.sail(player!!, Travel.FISHING_PLATFORM_TO_SMALL_ISLAND)
            }
            ...
            104 -> {
                ...
                FishingPlatformBoat.sail(player!!, Travel.FISHING_PLATFORM_TO_WITCHAVEN)
            }

            200 -> npc(FaceAnim.THINKING, "You're right. It all sounds pretty creepy.").also { stage++ }
            201 -> {
                end()
                FishingPlatformBoat.sail(player!!, Travel.SMALL_ISLAND_TO_FISHING_PLATFORM)
            }

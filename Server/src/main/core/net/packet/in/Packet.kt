...
sealed class Packet {
    ...
    data class UseWithNpc(val player: Player, val itemId: Int, val npcIndex: Int, val iface: Int, val slot: Int) :
        Packet()

    data class UseWithPlayer(val player: Player, val itemId: Int, val otherIndex: Int, val iface: Int, val slot: Int) :
        Packet()
    ...
    data class ContinueOption(val player: Player, val iface: Int, val child: Int, val slot: Int, val opcode: Int) :
        Packet()
    ...
    data class ComponentItemAction(val player: Player, val iface: Int, val child: Int, val itemId: Int, val slot: Int) :
        Packet()

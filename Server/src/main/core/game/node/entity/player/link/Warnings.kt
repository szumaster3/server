...
enum class Warnings(
    ...
    WILDERNESS_DITCH(Vars.VARBIT_WILDERNESS_WARNING_382_3857, Components.WILDERNESS_WARNING_382, 67, { WarningActions::handleWildernessJump }),
    CORPOREAL_BEAST_DANGEROUS(Vars.VARBIT_CORPOREAL_BEAST_DANGEROUS_5366, Components.CWS_WARNING_30_650, 78, WarningActions::handleCorporalBeast),
    ...
    SHANTAY_PASS(Vars.VARBIT_CWS_WARNING_10_3860, Components.CWS_WARNING_10_565, 63, WarningActions::handleShantayPass),
    FAIRY_RING_TO_DORGESH_KAAN(Vars.VARBIT_CWS_WARNING_15_3865, Components.CWS_WARNING_15_578, 59, WarningActions::handleFairyRing),
    MORT_MYRE(Vars.VARBIT_CWS_WARNING_20_3870, Components.CWS_WARNING_20_580, 61, WarningActions::handleMortMyreGate),
    DORGESH_KAAN_CITY_EXIT(Vars.VARBIT_CWS_WARNING_16_3869, Components.CWS_WARNING_16_569, 68, {}),
    RANGING_GUILD(Vars.VARBIT_CWS_WARNING_23_3871, Components.CWS_WARNING_23_564, 70, WarningActions::handleRangingGuild),
    ...
    FALADOR_MOLE_LAIR(Vars.VARBIT_CWS_WARNING_3_3853, Components.CWS_WARNING_3_568, 53, WarningActions::handleMoleTunnel),
    STRONGHOLD_OF_SECURITY_LADDERS(Vars.VARBIT_CWS_WARNING_4_3854, Components.CWS_WARNING_4_579, 52, WarningActions::handleStrongholdLadder),
    WATCHTOWER_SHAMAN_CAVE(Vars.VARBIT_CWS_WARNING_12_3862, Components.CWS_WARNING_12_573, 65, WarningActions::handleWatchtower),
    LUMBRIDGE_SWAMP_CAVE_ROPE(Vars.VARBIT_CWS_WARNING_17_3863, Components.CWS_WARNING_17_570, 51, WarningActions::handleSwampCave),
    ...
    ICY_PATH_AREA(Vars.VARBIT_ICY_PATH_AREA_3861, -1, 57, {});

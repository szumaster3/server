...
public final class BankContainer extends Container {
	 ...
	 */
	public static final int DEPOSIT_BOX = Components.BANK_DEPOSIT_BOX_11;

	/**
	 * The main bank interface id.
	 */
	public static final int BANK_V2_MAIN = Components.BANK_V2_MAIN_762;

	/**
	 * The bank side interface id.
	 */
	public static final int BANK_V2_MAIN_SIDE = Components.BANK_V2_SIDE_763;

	/**
	 * The bank child id.
	 */
	private static final int BANK_CHILD_ID = 64000;
	 ...
	 * The main inv size.
	 */
	private static final int MAIN_CONTAINER_TYPE = 95;

	/**
	 * The side inv size.
	 */
	private static final int SIDE_CONTAINER_TYPE = 93;

	/**
	 * The inv size.
	 */
	private static final int SIDE_DEFAULT_CAPACITY = 28;
	...
	public void refreshDepositBoxInterface() {
		InterfaceContainer.generateItems(
				...
				DEPOSIT_BOX,
				15,
				List.of("Deposit-X", "Deposit-All", "Deposit-10", "Deposit-5", "Deposit-1"),
				5,
				7,
				0
		);
	...
	public void setInsertItems(boolean insertItems) {
		setVarbit(player, Vars.VARP_IFACE_BANK_INSERT_MODE_304, insertItems ? 1 : 0, true);
	}
	...
	public boolean isInsertItems() {
		return getVarbit(player, Vars.VARP_IFACE_BANK_INSERT_MODE_304) == 1;
	}

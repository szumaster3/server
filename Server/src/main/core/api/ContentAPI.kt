...
/**
 * Opens the Grand Exchange collection box for the player.
 *
...
/**
 * Opens the player's bank account interface.
 *
...
/**
 * Opens the player's deposit box interface.
 *
...
/**
 * Opens the player's bank pin settings.
 *

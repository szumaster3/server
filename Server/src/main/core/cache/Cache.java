...
public final class Cache {
    ...
    public static ByteBuffer getArchiveData(int index, int archive, boolean priority, int encryptionValue) {
        ...
        // TODO There are two archives that lack two bytes at the end (The version, most likely).
        //  This causes the client CRC to be miscalculated. To combat this, we simply send two more
        //  bytes if the length seems to be off.
